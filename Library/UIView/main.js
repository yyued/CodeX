...
UIView.xib_addSublayers = function (layer, xml) {
...
UIView.xib_codeWithProps = function (props, xml) {
    ...
    if (props.cornerRadius !== undefined) {
        $(xml).find(':first').find('userDefinedRuntimeAttributes:eq(0)').append('<userDefinedRuntimeAttribute type="number" keyPath="layer.cornerRadius"><real key="value" value="' + props.cornerRadius + '"/></userDefinedRuntimeAttribute>');
    }
    if (props.masksToBounds === true) {
        $(xml).find(':first').find('userDefinedRuntimeAttributes:eq(0)').append('<userDefinedRuntimeAttribute type="boolean" keyPath="layer.masksToBounds" value="YES"/>');
    }
    if (props.borderColor !== undefined && oc_color(props.borderColor) != "nil") {
        $(xml).find(':first').find('userDefinedRuntimeAttributes:eq(0)').append('<userDefinedRuntimeAttribute type="color" keyPath="cox_borderColor">' + xib_color('value', props.borderColor) + '</userDefinedRuntimeAttribute>');
    }
    if (props.borderWidth !== undefined) {
        $(xml).find(':first').find('userDefinedRuntimeAttributes:eq(0)').append('<userDefinedRuntimeAttribute type="number" keyPath="layer.borderWidth"><real key="value" value="' + props.borderWidth + '"/></userDefinedRuntimeAttribute>');
    }
    if (props.tintColor !== undefined) {
    ...
    if (props.constraints !== undefined) {
        ...
        if (props.constraints.centerHorizontally == 1) {
            $(xml).find(':first').find('userDefinedRuntimeAttributes:eq(0)').append('<userDefinedRuntimeAttribute type="boolean" keyPath="cox_constraint.centerHorizontally" value="YES"/>');
        }
        if (props.constraints.centerVertically == 1) {
            $(xml).find(':first').find('userDefinedRuntimeAttributes:eq(0)').append('<userDefinedRuntimeAttribute type="boolean" keyPath="cox_constraint.centerVertically" value="YES"/>');
        }
        if (props.constraints.sizeRelativeTo == 2) {
            $(xml).find(':first').find('userDefinedRuntimeAttributes:eq(0)').append('<userDefinedRuntimeAttribute type="number" keyPath="cox_constraint.sizeRelate"><integer key="value" value="1"/></userDefinedRuntimeAttribute>');
        }
        if (props.constraints.useFixedWidth == 1 && props.constraints.fixedWidth !== undefined) {
            $(xml).find(':first').find('userDefinedRuntimeAttributes:eq(0)').append('<userDefinedRuntimeAttribute type="string" keyPath="cox_constraint.width" value="' + props.constraints.fixedWidth + '"/>');
        }
        if (props.constraints.useFixedHeight == 1 && props.constraints.fixedHeight !== undefined) {
            $(xml).find(':first').find('userDefinedRuntimeAttributes:eq(0)').append('<userDefinedRuntimeAttribute type="string" keyPath="cox_constraint.height" value="' + props.constraints.fixedHeight + '"/>');
        }
        if (props.constraints.pinRelativeTo == 2) {
            $(xml).find(':first').find('userDefinedRuntimeAttributes:eq(0)').append('<userDefinedRuntimeAttribute type="number" keyPath="cox_constraint.pinRelate"><integer key="value" value="1"/></userDefinedRuntimeAttribute>');
        }
        if (props.constraints.useTopPinning == 1 && props.constraints.topPinning !== undefined) {
            $(xml).find(':first').find('userDefinedRuntimeAttributes:eq(0)').append('<userDefinedRuntimeAttribute type="string" keyPath="cox_constraint.top" value="' + props.constraints.topPinning + '"/>');
        }
        if (props.constraints.useLeftPinning == 1 && props.constraints.leftPinning !== undefined) {
            $(xml).find(':first').find('userDefinedRuntimeAttributes:eq(0)').append('<userDefinedRuntimeAttribute type="string" keyPath="cox_constraint.left" value="' + props.constraints.leftPinning + '"/>');
        }
        if (props.constraints.useBottomPinning == 1 && props.constraints.bottomPinning !== undefined) {
            $(xml).find(':first').find('userDefinedRuntimeAttributes:eq(0)').append('<userDefinedRuntimeAttribute type="string" keyPath="cox_constraint.bottom" value="' + props.constraints.bottomPinning + '"/>');
        }
        if (props.constraints.useRightPinning == 1 && props.constraints.rightPinning !== undefined) {
            $(xml).find(':first').find('userDefinedRuntimeAttributes:eq(0)').append('<userDefinedRuntimeAttribute type="string" keyPath="cox_constraint.right" value="' + props.constraints.rightPinning + '"/>');
        }
    }
    if (props.adjustFrame === true) {
        $(xml).find(':first').find('userDefinedRuntimeAttributes:eq(0)').append('<userDefinedRuntimeAttribute type="boolean" keyPath="cox_automaticallyAdjustsSpace" value="YES"/>');
    }
}

UIView.xib_global = function(id, layer, xmlString) {
    if (layer.sublayers !== undefined && layer.sublayers.length > 0) {
        for (var index = 0; index < layer.sublayers.length; index++) {
            var sublayer = layer.sublayers[index];
            if (window[sublayer.class] !== undefined && window[sublayer.class].xib_global !== undefined) {
                xmlString = window[sublayer.class].xib_global(sublayer.id, sublayer, xmlString);
            }
        }
    }
    return xmlString;
